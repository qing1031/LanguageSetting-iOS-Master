...
#define KSHeadRefreshView_T_1 MYLocalizedString(@"下拉刷新", @"Pull down refresh")
#define KSHeadRefreshView_T_2 MYLocalizedString(@"松开刷新", @"Undo refresh")
#define KSHeadRefreshView_T_3 MYLocalizedString(@"加载中...", @"Loading...")
